    ...
    return (
        <div className="container mx-auto">
            <div className="relative">
                <img src="src\carousel.jpg" alt="Athletes running on a track" className="w-full h-96 object-cover" />
            ...
            <div className="flex items-center justify-center my-8">
                <img src="src\pages\shaurya .jpg" alt="Logo" className="w-28 h-29 object-cover mr-4" />
                <h2 className="text-6xl font-bold">GLIMPSES OF 2024 EVENTS</h2>
            </div>
            <div className="grid grid-cols-1 gap-8 px-4">
                <div className="flex flex-col md:flex-row items-center">
                    <img src="src\pages\sports day.jpg" alt="National Sports Day poster" className="w-80 h-80 object-cover" />
                ...
                <div className="flex flex-wrap justify-center">
                    <img src="src\pages\dodge ball.jpg" alt="Tug of War illustration" className="w-90 h-80 object-cover m-2" />
                    <img src="src\pages\tow.png" alt="Engineer's Day Sports Events poster" className="w-80 h-80 object-cover m-2" />
                </div>
                <div className="flex flex-col md:flex-row items-center">
                    <img src="src\pages\engn day.jpg" alt="SAMAR poster" className="w-80 h-90 object-cover" />
                    <p className="mt-4 md:mt-0 md:ml-4 text-center md:text-left flex-1">
                ...
                <div className="flex flex-wrap justify-center">
                    ...
                    <img src="src\pages\mchairs.jpg" alt="Musical note illustration" className="w-80 h-80 object-cover m-2" />
                ...
                <div className="flex flex-col md:flex-row items-center mt-8">
                    <img src="src\pages\samar.jpg" alt="Additional Event poster" className="w-80 h-90 object-cover" />
                    <p className="mt-4 md:mt-0 md:ml-4 text-center md:text-left flex-1">
            ...
            <div className="flex flex-wrap justify-center mt-8">
                <img src="src\pages\ball.jpg" alt="cricketball illustration" className="w-80 h-80 object-cover m-2" />
                <img src="src\pages\9.jpg" alt="basketball illustration" className="w-80 h-80 object-cover m-2" />
            ...
            <div className="flex flex-wrap justify-center mt-8">
                <img src="src\pages\11.jpg" alt="Running athlete illustration" className="w-80 h-80 object-cover m-2" />
                <img src="src\pages\10.jpg" alt="Horse riding illustration" className="w-80 h-80 object-cover m-2" />
            </div>
        </div>
    );
}
