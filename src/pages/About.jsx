    ...
    return (
        <div className='xl:bg-[url("../Assets/aboutbg.jpeg")] bg-[url("../Assets/mob.jpg")]   bg-cover bg-fixed min-h-screen overflow-hidden'>
            <div className='backdrop-blur'>
                ...
                <div className='relative flex justify-center items-center xl:h-screen h-[60vh]  w-screen top-0 z-2 left-0 mt-20'>
                    {/* Center Box */}
                ...
                <div className='relative flex justify-center items-center xl:h-screen h-[60vh] w-screen  top-0 left-0 mt-20'>
