      ...
      <div className="shaurya__footer-container1">
        ...
        <div className="shaurya__footer-social-container">
          <div className="shaurya__footer-social-links-container">
            <a target="_blank" href="https://www.facebook.com/shaurya.nitrr/">
              <svg
                fill="#999"
                width="32"
                height="32"
            ...
            <a
              target="_blank"
              href="https://www.instagram.com/samar.nitrr/"
            >
              <svg
                fill="#999"
                width="32"
            ...
            <a
              target="_blank"
              href="https://www.linkedin.com/company/team-shaurya-sports-committee-of-nit-raipur/"
            >
              <svg
                fill="#999"
                width="32"
          ...
          <p className="shaurya__footer-social-text">For more updates,</p>
          <p className="shaurya__footer-social-text">
